...
layout(location = 6) out vec3 objectCenter;  // obje merkezi (yildiz isik yonu icin; varying ile guvenilir)
...
void main() {
	...
	objectCenter = vec3(modelMatrix[3]);  // translation = obje dunya konumu
}